...
from lw_mlearn.utilis.utilis import get_kwargs, to_num_datetime
...
def bin_tree(X,
             ...
             verbose=0,
             **kwargs):
    '''feature binning based on DT model
    
    Based on univariate run of DecisionTree classifier
    ...
    **kwargs
    ...
    Return dict {col_name : bin_edges }
        - bin_edges  
